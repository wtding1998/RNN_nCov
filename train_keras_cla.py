...
if opt.rnn_model == 'GRU_module':
    model = GRU_module_cl(opt.nx*opt.nd, opt.nhid, opt.nlayers, opt.nx*opt.nd, test_input, opt.nx, opt.nd, activation=opt.activation, lr=opt.lr, dropout=opt.dropout)
...
if opt.rnn_model == 'GRU_Linear':
    model = GRU_Linear_cl(opt.nx*opt.nd, opt.nhid, opt.nlayers, opt.nx*opt.nd, test_input, opt.nx, opt.nd, activation=opt.activation, lr=opt.lr, dropout=opt.dropout)

if opt.rnn_model == 'LSTM_Linear':
    model = LSTM_Linear_cl(opt.nx*opt.nd, opt.nhid, opt.nlayers, opt.nx*opt.nd, test_input, opt.nx, opt.nd, activation=opt.activation, lr=opt.lr, dropout=opt.dropout)
