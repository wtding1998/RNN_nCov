...
if __name__ == "__main__":
    ...
    p.add('--outputdir', type=str, help='outputdir', default='feb0511')
    ...
    p.add('--model', type=str, help='model', default='v1')
    ...
    p.add('--nhid', type=int,nargs='+', help='time to pred', default=[10, 100])
    p.add('--nz', type=int,nargs='+', help='time to pred', default=[10])
    ...
    p.add('--batch_size', type=int, default=1000)
